    ...
    pillars: {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'Advanced ship recycling and maritime decommissioning. Pioneering sustainable end-of-life solutions for the global fleet through Primal AOS methodology — responsible demolition that transforms maritime heritage into recoverable value.',
          stat: '€50K',
        ...
        },
        {
          ...
          body: 'Design system architecture and AI integration for the largest home improvement platform in the Benelux. Apple-inspired design language, agent-ready infrastructure, built to scale.',
          stat: '2026',
    ...
    pillars: {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'Maritiem',
          subtitle: 'Van Diemen AOS',
          body: 'Geavanceerde scheepsrecycling en maritieme ontmanteling. Pionier in duurzame end-of-life oplossingen voor de wereldvloot via Primal AOS-methodologie — verantwoorde sloop die maritiem erfgoed omzet in herwinbare waarde.',
          stat: '€50K',
        ...
        },
        {
          ...
          title: 'Platform',
          subtitle: 'Solvari Design',
          body: 'Design system-architectuur en AI-integratie voor het grootste woningverbeteringsplatform van de Benelux. Apple-geïnspireerde designtaal, agent-klare infrastructuur — gebouwd om te schalen.',
          stat: '2026',
    ...
    pillars: {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'Merenkulku',
          subtitle: 'Van Diemen AOS',
          body: 'Edistynyt laivojen kierrätys ja merenkulun käytöstäpoisto. Pioneeri kestävissä elinkaaren loppuratkaisuissa maailmanlaajuiselle laivastolle Primal AOS -menetelmällä — vastuullinen purku, joka muuntaa merenkulkuperinnön takaisin arvoksi.',
          stat: '50 000 €',
        ...
        },
        {
          ...
          title: 'Alusta',
          subtitle: 'Solvari Design',
          body: 'Suunnittelujärjestelmäarkkitehtuuri ja tekoälyintegraatio Benelux-maiden suurimmalle kodinparannusalustalle. Apple-inspiroitu suunnittelukieli, agenttikelpoinen infrastruktuuri — rakennettu skaalautumaan.',
          stat: '2026',
    ...
    pillars: {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'البحرية',
          subtitle: 'Van Diemen AOS',
          body: 'إعادة تدوير السفن المتقدمة وإيقاف تشغيل الأساطيل البحرية. رواد في حلول نهاية العمر الافتراضي المستدامة للأسطول العالمي عبر منهجية Primal AOS — هدم مسؤول يحيل التراث البحري إلى قيمة قابلة للاسترداد.',
          stat: '٥٠ ألف يورو',
          statLabel: 'أول عقد',
        },
        {
        ...
        },
        {
          ...
          title: 'المنصة',
          subtitle: 'Solvari Design',
          body: 'هندسة نظام التصميم وتكامل الذكاء الاصطناعي لأكبر منصة لتحسين المنازل في منطقة البنيلوكس. لغة تصميم مستوحاة من Apple، بنية تحتية جاهزة للوكلاء — مبنية للتوسع.',
          stat: '٢٠٢٦',
